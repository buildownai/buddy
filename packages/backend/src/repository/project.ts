...
export const projectRepository = {
  createProjectForUser: async (userId: string, repositoryUrl: string, localFolder?: string) => {
  ...
  updateProject: async (projectId: string, input: Partial<Omit<ProjectDB, 'id' | 'createdAt'>>) => {
    const db = await getDb()
