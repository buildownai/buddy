...
const paramSchema = z.object({
  searchQuery: z.string().describe('Question about which context information is needed'),
})
    ...
    function: {
      ...
      function: async (input: unknown) => {
        try {
          ...
          const context = (await knowledgeRepository.findKnowledge(projectId, searchQuery))
